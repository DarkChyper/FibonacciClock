...
public class Fenetre extends JFrame {
	...
	private final JMenuItem itemStandard = new JMenuItem("Standard"), 
			...
			itemRegles = new JMenuItem("Règles"),
	...
	private void initMenu() {
		...
		close.setFont(f);
		close.setPreferredSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		close.setMaximumSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		close.setMinimumSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		close.setBorder(null);

		reduce.setForeground(Color.WHITE);
		reduce.setBackground(Color.black);
		reduce.setFont(f);
		reduce.setPreferredSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		reduce.setMaximumSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		reduce.setMinimumSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		reduce.setBorder(null);

		maximize.setForeground(Color.WHITE);
		maximize.setBackground(Color.black);
		maximize.setFont(f);
		maximize.setPreferredSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		maximize.setMaximumSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		maximize.setMinimumSize(new Dimension(EnumNombres.VINGT.getNombre(),EnumNombres.VINGT.getNombre()));
		...
		itemRegles.addActionListener(new ActionListener(){
			...
			public void actionPerformed(final ActionEvent arg0) {    
				...
				final String message = ConstantesString.REGLES;
